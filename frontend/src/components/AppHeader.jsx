...
export default function AppHeader({ section, user, onLogout, actions }) {
  ...
  return (
    <header className="flex items-center justify-between px-3 sm:px-6 py-0 h-14 shrink-0"
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <span className="text-xs px-2 py-0.5 rounded-md font-medium hidden sm:inline-block"
      ...
      {menuOpen && (
        <div className="absolute top-14 left-0 right-0 z-50 p-4 flex flex-col gap-3"
          style={{ background: 'var(--bg-card)', borderBottom: '1px solid var(--border)' }}>
          <div className="flex items-center gap-2 pb-3" style={{ borderBottom: '1px solid var(--border)' }}>
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: 'var(--text-muted)' }}>{section}</p>
            </div>
          </div>
